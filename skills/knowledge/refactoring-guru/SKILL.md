...
description: Apply the Refactoring.Guru knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with refactoring-guru`, or asks for practical smell diagnosis, refactoring technique selection, and controlled cleanup.
---
...
Imported from `ciembor/agent-rules-books` (`refactoring-guru.mini.md`), MIT licensed.
