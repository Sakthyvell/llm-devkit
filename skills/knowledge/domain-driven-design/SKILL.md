...
description: Apply the Domain-Driven Design knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with domain-driven-design`, or asks for domain modeling, ubiquitous language, bounded contexts, and strategic design.
---
...
Imported from `ciembor/agent-rules-books` (`domain-driven-design.mini.md`), MIT licensed.
