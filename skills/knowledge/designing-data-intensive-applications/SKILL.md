...
description: Apply the Designing Data-Intensive Applications knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with designing-data-intensive-applications`, or asks for data ownership, events, streams, replication, consistency, transactions, and schema evolution.
---
...
Imported from `ciembor/agent-rules-books` (`designing-data-intensive-applications.mini.md`), MIT licensed.
