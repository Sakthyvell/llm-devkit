...
description: Apply the A Philosophy of Software Design knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with a-philosophy-of-software-design`, or asks for API design, module depth, information hiding, and complexity-reducing refactors.
---
...
Imported from `ciembor/agent-rules-books` (`a-philosophy-of-software-design.mini.md`), MIT licensed.
