...
description: Apply the Patterns of Enterprise Application Architecture knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with patterns-of-enterprise-application-architecture`, or asks for enterprise layering, service layer, repositories, units of work, mappers, DTOs, and transaction patterns.
---
...
Imported from `ciembor/agent-rules-books` (`patterns-of-enterprise-application-architecture.mini.md`), MIT licensed.
