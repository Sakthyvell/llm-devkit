...
description: Apply the Implementing Domain-Driven Design knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with implementing-domain-driven-design`, or asks for aggregates, domain events, context integration, application services, and implementation-level DDD.
---
...
Imported from `ciembor/agent-rules-books` (`implementing-domain-driven-design.mini.md`), MIT licensed.
