---
name: release-it
description: Apply the Release It! knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with release-it`, or asks for production reliability, timeouts, retries, circuit breakers, bulkheads, observability, and overload.
---
...
Imported from `ciembor/agent-rules-books` (`release-it.mini.md`), MIT licensed.
