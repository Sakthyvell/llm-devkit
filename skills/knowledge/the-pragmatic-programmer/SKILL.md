...
description: Apply the The Pragmatic Programmer knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with the-pragmatic-programmer`, or asks for pragmatic engineering, DRY knowledge, orthogonality, automation, feedback, and adaptability.
---
...
Imported from `ciembor/agent-rules-books` (`the-pragmatic-programmer.mini.md`), MIT licensed.
