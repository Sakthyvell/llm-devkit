---
name: refactoring
description: Apply the Refactoring knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with refactoring`, or asks for behavior-preserving structural improvement, code smells, tests, and small safe refactor steps.
---
...
Imported from `ciembor/agent-rules-books` (`refactoring.mini.md`), MIT licensed.
