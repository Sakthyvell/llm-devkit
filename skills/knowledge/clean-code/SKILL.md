---
name: clean-code
description: Apply the Clean Code knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with clean-code`, or asks for readability, naming, small functions, responsibilities, tests, and everyday code review.
---
...
Imported from `ciembor/agent-rules-books` (`clean-code.mini.md`), MIT licensed.
