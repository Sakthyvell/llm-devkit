...
description: Apply the Clean Architecture knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with clean-architecture`, or asks for stable boundaries, dependency direction, and separating policy from frameworks or databases.
---
...
Imported from `ciembor/agent-rules-books` (`clean-architecture.mini.md`), MIT licensed.
