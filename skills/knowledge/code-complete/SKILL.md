---
name: code-complete
description: Apply the Code Complete knowledge standard as task-scoped engineering guidance. Use when the user explicitly invokes this knowledge skill, says `with code-complete`, or asks for disciplined construction, routine design, defensive programming, testing, and maintainability.
---
...
Imported from `ciembor/agent-rules-books` (`code-complete.mini.md`), MIT licensed.
